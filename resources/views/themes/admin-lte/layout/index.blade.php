...
<head>
    ...
    <!-- Bootstrap 3.3.6 -->
    <link rel="stylesheet" href="{{URL::asset('admin-lte/bootstrap/css/bootstrap.min.css')}}">
    <!-- Font Awesome -->
    @if ('local' === getenv('APP_ENV'))
        <link rel="stylesheet" href="{{URL::asset('gentelella/vendors/fontawesome/css/font-awesome.css')}}">
        <link rel="stylesheet" href="{{URL::asset('admin-lte/dev-only/ionicons.min.css')}}">
    @else
        <link rel="stylesheet"
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="{{URL::asset('admin-lte/plugins/iCheck/flat/blue.css')}}">
        <!-- Morris chart -->
        <link rel="stylesheet" href="{{URL::asset('admin-lte/plugins/morris/morris.css')}}">
        <!-- jvectormap -->
        <link rel="stylesheet" href="{{URL::asset('admin-lte/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}">
        <!-- Date Picker -->
        <link rel="stylesheet" href="{{URL::asset('admin-lte/plugins/datepicker/datepicker3.css')}}">
        <!-- Daterange picker -->
        <link rel="stylesheet" href="{{URL::asset('admin-lte/plugins/daterangepicker/daterangepicker.css')}}">
...
<div class="wrapper">
    {!! view('themes.admin-lte.common.header') !!}
            <!-- Left side column. contains the logo and sidebar -->
    {!! view('themes.admin-lte.common.sidebar') !!}
            <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        <!-- Content Header (Page header) -->
        {!! view('themes.admin-lte.common.breadcrumb') !!}
    ...
    <!-- Control Sidebar -->
    {{--{!! view('themes.admin-lte.common.control-sidebar') !!}--}}
    <!-- /.control-sidebar -->
...
<!-- jQuery Knob Chart -->
<script src="{{URL::asset('admin-lte/plugins/knob/jquery.knob.js')}}"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="{{URL::asset('admin-lte/plugins/daterangepicker/daterangepicker.js')}}"></script>
<!-- datepicker -->
<script src="{{URL::asset('admin-lte/plugins/datepicker/bootstrap-datepicker.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
